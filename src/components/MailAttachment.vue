<template>
    <div>
        <b-row style="margin:10px;">
            ...
            <b-button to="/mail_attchement" variant="success"  style="margin-right:5px;">Email Attachment</b-button>
            <b-button to="/mail_images" disabled="disabled" style="margin-right:5px;">Email with Images</b-button>
            <b-button to="/customize_mail" style="margin-right:5px;">Customize Mail</b-button>
        </b-row>
        <h1>Mail Attachment</h1>
        ...
        <b-card-body title="Message Preview" style="float:left">
          <b-card-text style="width:100%">
            <p class="dt">
             ...
             <p class="dt">
               <span class="tt">Subjects :</span> <b>{{form.subject}}</b>
            </p>
             <p class="dt">
...
export default {
    ...
    methods: {
      onSubmit(evt) {
        ...
        let mailFile = this.form.file.files
        this.errors = []
        if(!this.form.sender){
        ...
        this.$http.post('bing/mail.php','var='+JSON.stringify(data),{ headers : {
