<template>
    <div>
        <b-row style="margin:10px;">
            <b-button to="/simple_mail" variant="success" style="margin-right:5px;">Simple Mail</b-button>
            <b-button to="/mail_attchement" disabled="disabled" style="margin-right:5px;">Email Attachment</b-button>
            <b-button to="/mail_images" disabled="disabled" style="margin-right:5px;">Email with Images</b-button>
            <b-button to="/customize_mail" disabled="disabled" style="margin-right:5px;">Customize Mail</b-button>
        </b-row>
        <h1>Simple Mail</h1>
